...
export const COURSES_CONTENTS = {
  'IELTS Starter (1.0 - 3.0)': {
    id: 'course_1',
    name: 'IELTS Starter (1.0 - 3.0)',
...
// Page Index
export const PAGE_INDEX__ABOUT_US_CONTENT = 'YES ENGLISH là trung tâm đào tạo tiếng Anh trực tuyến, chuyên cung cấp các khóa học luyện thi IELTS và tiếng Anh giao tiếp. Với hơn 5 năm kinh nghiệm giảng dạy online, YES ENGLISH khẳng định thế mạnh vượt trội trong việc cung cấp giải pháp học tập hiện đại, chất lượng cao, tiết kiệm thời gian, chi phí mà vẫn đạt hiệu quả tối đa.';
...
export const COURSES_INFO = {
  ielts: {
    ...
    status: 'open',
    courses: [
      COURSES_CONTENTS["IELTS Starter (1.0 - 3.0)"],
      COURSES_CONTENTS["IELTS Explorer (3.0 - 4.5)"],
      COURSES_CONTENTS["IELTS Builder (4.5 - 5.5)"],
      COURSES_CONTENTS["IELTS Beyond (5.5 - 6.5)"],
      COURSES_CONTENTS["IELTS Winner (6.5 - 7.5)"],
      COURSES_CONTENTS["IELTS Champion (8.0+)"]
    ]
  },
  communication: {
    ...
    status: null,
    courses: [
      COURSES_CONTENTS["Khóa Tiếng Anh Định Cư"],
      COURSES_CONTENTS["Khóa Tiếng Anh Giao Tiếp"]
    ]
  },
  others: {
    title: 'CÁC KHOÁ HỌC KHÁC',
    status: null,
    courses: [
      COURSES_CONTENTS["Khóa Phát Âm"],
      COURSES_CONTENTS["Lớp kèm 1:1"]
    ]
  }
}

// Page About Us
export const PAGE_ABOUT_US__ABOUT_US_CONTENT = 'Là một nền tảng đào tạo tiếng Anh trực tuyến hàng đầu, YES ENGLISH mang đến cho học viên những giải pháp học tập hiệu quả trong lĩnh vực luyện thi IELTS và kỹ năng giao tiếp. Sau hơn 5 năm hoạt động trong ngành giáo dục trực tuyến, trung tâm đã phát triển một hệ thống học tập đột phá, giúp học viên nhanh chóng cải thiện trình độ tiếng Anh một cách chuyên nghiệp và tiết kiệm. Bằng phương pháp giảng dạy sáng tạo và đội ngũ giảng viên chuyên nghiệp, YES ENGLISH đã tạo nên một không gian học tập linh hoạt, phù hợp với nhu cầu và mục tiêu của từng học viên.';

// Page Test
export const PAGE_TEST__BACKGROUND_IMAGES = [
